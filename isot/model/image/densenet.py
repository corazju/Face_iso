...
class DenseNet(ImageModel, SimpleNet):

    def __init__(self, name='densenet', created_time=None, layer=None, model_class=_DenseNet, default_layer=121, **kwargs):
        super().__init__(name=name, created_time=created_time, layer=layer, model_class=model_class,default_layer=default_layer, **kwargs)
...
class DenseNetcomp(DenseNet, SimpleNet):

    def __init__(self, name='densenetcomp', layer=None, created_time=None, model_class=_DenseNetcomp, default_layer=121, **kwargs):
        super().__init__(name=name, layer=layer, created_time=created_time, model_class=model_class,
