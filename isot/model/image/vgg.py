...
class VGG(ImageModel, SimpleNet):

    # layer 13 or 16
    def __init__(self, name='vgg', created_time=None, layer=None, model_class=_VGG, default_layer=13, **kwargs):
...
class VGGcomp(VGG, SimpleNet):

    def __init__(self, name='vggcomp', created_time=None, model_class=_VGGcomp, **kwargs):
        super().__init__(name=name, created_time=created_time, model_class=model_class,
